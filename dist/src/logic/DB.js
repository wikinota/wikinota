...
export default DB;
export function decryptItemData(doc) {
    if (doc["cipher_text"] == undefined)
        return doc;
    const myObj = doc;
...
export function encryptItemData(doc) {
    if (doc["cryptData"] == undefined)
        return doc;
    const myObj = doc;
